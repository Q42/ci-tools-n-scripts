...
<xsl:template match="/">
 ...
 <svg xmlns="http://www.w3.org/2000/svg"
     ...
     xmlns:ev="http://www.w3.org/2001/xml-events" width="436pt" height="327pt" viewBox="0 0 4360 3270">
 ...
 <g transform="translate(190 640) rotate(-90)" fill ="#008080" font-family="Times New Roman" font-size="100px" text-anchor="end">
 ...
 <text x="4100" y="3110" fill ="#008080" font-family="Times New Roman" font-size="100px" text-anchor="end"><xsl:value-of select="$labelx"/></text>
